  ...
  courses = [
    {
      ...
      description: 'You will be given top quality ingredients -- aged for a year at great loss -- and used to build the potential of the meal.',
      items: [ 'Persimmons', 'Markelle malts', 'Embiid spices' ],
      zipCode: 19025
  },
    {
      title: 'Democracy muffins',
      description: 'Although this course does not always have the popular vote, results are bittersweet.',
      items: [ 'Orange', 'Vanilla', 'Sour cream' ],
      zipCode: 23512
  }, {
      title: 'One with everything',
      description: 'This class teaches you a recipe that includes multiple techniques. At the end, you will find enlightment in just ordering food in.',
